Create Database Radio_BigFM92_7_SQLChallenge;

Use Radio_BigFM92_7_SQLChallenge;
...
Select Showname, count(*) as No_of_awards from awards a join shows s on s.showid = a.showid group by showname;
